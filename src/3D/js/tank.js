...
function init() {
  ...
  let wheelSegments = 8;
  let wheelGeom = new THREE.CylinderBufferGeometry(wheelRadius, wheelRadius, wheelThickness, wheelSegments);
  ...
  let turretA = 0.03;
  let turretB = 0.1;
  let turretLength = carLength * 0.55 * 0.24;
  ...
  turret.position.z = turretLength * 0.5;
