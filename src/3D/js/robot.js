...
function init() {
  ...
  camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 17000);
  ...
  //moon
  let textureMoon = new THREE.TextureLoader().load('/3D/files/moon.png');
  ...
  //town
  new MTLLoader(manager).load('/3D/files/wild_town.mtl', function (materials) {
    materials.preload();

    new OBJLoader(manager).setMaterials(materials).load(
      '/3D/files/wild town.obj',
      function (town) {
  ...
  //robot
  new MTLLoader(manager).load('/3D/files/walking.mtl', function (materials) {
    materials.preload();

    new OBJLoader(manager).setMaterials(materials).load(
      '/3D/files/walking.obj',
      function (body) {
