...
//town
	new MTLLoader( manager )
		.load( '/3D/files/wild_town.mtl', function ( materials ) {
			materials.preload();

			new OBJLoader( manager )
			.setMaterials( materials )
			.load( '/3D/files/wild town.obj', function ( town ) {
...
//robot
	new MTLLoader( manager )
		.load( '/3D/files/walking.mtl', function ( materials ) {
			materials.preload();

			new OBJLoader( manager )
			.setMaterials( materials )
			.load( '/3D/files/walking.obj', function ( body ) {
